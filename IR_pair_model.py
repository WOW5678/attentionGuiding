...
class BertPairClassifier(torch.nn.Module):
    def __init__(self, nn_tokenizer, nn_bert_model, args):
        super(BertPairClassifier, self).__init__()
        self.args = args
        self.nn_bert_model = nn_bert_model
        self.nn_tokenizer = nn_tokenizer
        self.dropout = torch.nn.Dropout(0.1)
        self.classifier = torch.nn.Linear(768, args.class_nums)
